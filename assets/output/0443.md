...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`双指针`](/leetcode-js/outline/tag/two-pointers.md) [`字符串`](/leetcode-js/outline/tag/string.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/string-compression)
...
| 1313 | [解压缩编码列表](https://leetcode.com/problems/decompress-run-length-encoded-list) |  |  [`数组`](/leetcode-js/outline/tag/array.md) | <font color=#15bd66>Easy</font> |
| 3163 | [压缩字符串 III](https://leetcode.com/problems/string-compression-iii) |  |  [`字符串`](/leetcode-js/outline/tag/string.md) | <font color=#ffb800>Medium</font> |
| 3167 | [字符串的更好压缩](https://leetcode.com/problems/better-compression-of-string) |  |  [`哈希表`](/leetcode-js/outline/tag/hash-table.md) [`字符串`](/leetcode-js/outline/tag/string.md) [`计数`](/leetcode-js/outline/tag/counting.md) `1+` | <font color=#ffb800>Medium</font> |
