...
🟢 <font color=#15bd66>Easy</font>&emsp; 🔖&ensp; [`栈`](/leetcode-js/outline/tag/stack.md) [`设计`](/leetcode-js/outline/tag/design.md) [`队列`](/leetcode-js/outline/tag/queue.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/implement-queue-using-stacks)
