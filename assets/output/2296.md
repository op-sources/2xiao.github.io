...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`栈`](/leetcode-js/outline/tag/stack.md) [`设计`](/leetcode-js/outline/tag/design.md) [`链表`](/leetcode-js/outline/tag/linked-list.md) [`字符串`](/leetcode-js/outline/tag/string.md) [`双向链表`](/leetcode-js/outline/tag/doubly-linked-list.md) [`模拟`](/leetcode-js/outline/tag/simulation.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/design-a-text-editor)
