...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`线段树`](/leetcode-js/outline/tag/segment-tree.md) [`数组`](/leetcode-js/outline/tag/array.md) [`有序集合`](/leetcode-js/outline/tag/ordered-set.md) [`扫描线`](/leetcode-js/outline/tag/line-sweep.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/rectangle-area-ii)
