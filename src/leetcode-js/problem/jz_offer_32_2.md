...
🟢 <font color=#15bd66>Easy</font>&emsp; 🔖&ensp; [`树`](/leetcode-js/outline/tag/tree.md) [`广度优先搜索`](/leetcode-js/outline/tag/breadth-first-search.md) [`二叉树`](/leetcode-js/outline/tag/binary-tree.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.cn/problems/cong-shang-dao-xia-da-yin-er-cha-shu-ii-lcof)
