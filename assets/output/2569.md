...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`线段树`](/leetcode-js/outline/tag/segment-tree.md) [`数组`](/leetcode-js/outline/tag/array.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/handling-sum-queries-after-update)
