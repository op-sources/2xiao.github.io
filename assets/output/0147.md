...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`链表`](/leetcode-js/outline/tag/linked-list.md) [`排序`](/leetcode-js/outline/tag/sorting.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/insertion-sort-list)
...
| 708 | [循环有序列表的插入](https://leetcode.com/problems/insert-into-a-sorted-circular-linked-list) |  |  [`链表`](/leetcode-js/outline/tag/linked-list.md) | <font color=#ffb800>Medium</font> |
