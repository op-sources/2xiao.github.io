...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`数组`](/leetcode-js/outline/tag/array.md) [`桶排序`](/leetcode-js/outline/tag/bucket-sort.md) [`基数排序`](/leetcode-js/outline/tag/radix-sort.md) [`排序`](/leetcode-js/outline/tag/sorting.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/maximum-gap)
