...
[`数学`](/leetcode-js/outline/tag/math.md) [`数论`](/leetcode-js/outline/tag/number-theory.md) [`几何`](/leetcode-js/outline/tag/geometry.md) [`博弈`](/leetcode-js/outline/tag/game-theory.md) [`模拟`](/leetcode-js/outline/tag/simulation.md) [`组合数学`](/leetcode-js/outline/tag/combinatorics.md) [`随机化`](/leetcode-js/outline/tag/randomized.md) [`概率与统计`](/leetcode-js/outline/tag/probability-and-statistics.md) [`水塘抽样`](/leetcode-js/outline/tag/reservoir-sampling.md) [`拒绝采样`](/leetcode-js/outline/tag/rejection-sampling.md) [`数据库`](/leetcode-js/outline/tag/database.md) [`设计`](/leetcode-js/outline/tag/design.md) [`数据流`](/leetcode-js/outline/tag/data-stream.md) [`脑筋急转弯`](/leetcode-js/outline/tag/brainteaser.md) <span class="blue">交互</span> [`迭代器`](/leetcode-js/outline/tag/iterator.md) [`多线程`](/leetcode-js/outline/tag/concurrency.md)
:::
...
| 题号 | 标题 | 题解 | 标签 | 难度 |
| :------: | :------ | :------: | :------ | :------ |
| 157 | [用 Read4 读取 N 个字符](https://leetcode.com/problems/read-n-characters-given-read4) |  |  [`数组`](/leetcode-js/outline/tag/array.md) [`交互`](/leetcode-js/outline/tag/interactive.md) [`模拟`](/leetcode-js/outline/tag/simulation.md) | <font color=#15bd66>Easy</font> |
| 158 | [用 Read4 读取 N 个字符 II - 多次调用](https://leetcode.com/problems/read-n-characters-given-read4-ii-call-multiple-times) |  |  [`数组`](/leetcode-js/outline/tag/array.md) [`交互`](/leetcode-js/outline/tag/interactive.md) [`模拟`](/leetcode-js/outline/tag/simulation.md) | <font color=#ff334b>Hard</font> |
| 277 | [搜寻名人](https://leetcode.com/problems/find-the-celebrity) |  |  [`图`](/leetcode-js/outline/tag/graph.md) [`双指针`](/leetcode-js/outline/tag/two-pointers.md) [`交互`](/leetcode-js/outline/tag/interactive.md) | <font color=#ffb800>Medium</font> |
...
| 489 | [扫地机器人](https://leetcode.com/problems/robot-room-cleaner) |  |  [`回溯`](/leetcode-js/outline/tag/backtracking.md) [`交互`](/leetcode-js/outline/tag/interactive.md) | <font color=#ff334b>Hard</font> |
...
| 1236 | [网络爬虫](https://leetcode.com/problems/web-crawler) |  |  [`深度优先搜索`](/leetcode-js/outline/tag/depth-first-search.md) [`广度优先搜索`](/leetcode-js/outline/tag/breadth-first-search.md) [`字符串`](/leetcode-js/outline/tag/string.md) `1+` | <font color=#ffb800>Medium</font> |
...
| 1428 | [至少有一个 1 的最左端列](https://leetcode.com/problems/leftmost-column-with-at-least-a-one) |  |  [`数组`](/leetcode-js/outline/tag/array.md) [`二分查找`](/leetcode-js/outline/tag/binary-search.md) [`交互`](/leetcode-js/outline/tag/interactive.md) `1+` | <font color=#ffb800>Medium</font> |
...
| 1778 | [未知网格中的最短路径](https://leetcode.com/problems/shortest-path-in-a-hidden-grid) |  |  [`深度优先搜索`](/leetcode-js/outline/tag/depth-first-search.md) [`广度优先搜索`](/leetcode-js/outline/tag/breadth-first-search.md) [`图`](/leetcode-js/outline/tag/graph.md) `1+` | <font color=#ffb800>Medium</font> |
| 1810 | [隐藏网格下的最小消耗路径](https://leetcode.com/problems/minimum-path-cost-in-a-hidden-grid) |  |  [`深度优先搜索`](/leetcode-js/outline/tag/depth-first-search.md) [`广度优先搜索`](/leetcode-js/outline/tag/breadth-first-search.md) [`图`](/leetcode-js/outline/tag/graph.md) `2+` | <font color=#ffb800>Medium</font> |
| 2728 | [计算一个环形街道上的房屋数量](https://leetcode.com/problems/count-houses-in-a-circular-street) |  |  [`数组`](/leetcode-js/outline/tag/array.md) [`交互`](/leetcode-js/outline/tag/interactive.md) | <font color=#15bd66>Easy</font> |
| 2782 | [唯一类别的数量](https://leetcode.com/problems/number-of-unique-categories) |  |  [`并查集`](/leetcode-js/outline/tag/union-find.md) [`计数`](/leetcode-js/outline/tag/counting.md) [`交互`](/leetcode-js/outline/tag/interactive.md) | <font color=#ffb800>Medium</font> |
