...
| 3320 | [统计能获胜的出招序列数](https://leetcode.com/problems/count-the-number-of-winning-sequences) |  |  [`字符串`](/leetcode/outline/tag/string.md) [`动态规划`](/leetcode/outline/tag/dynamic-programming.md) | <font color=#ff334b>Hard</font> |
