...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`并查集`](/leetcode-js/outline/tag/union-find.md) [`图`](/leetcode-js/outline/tag/graph.md) [`数组`](/leetcode-js/outline/tag/array.md) [`最小生成树`](/leetcode-js/outline/tag/minimum-spanning-tree.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/min-cost-to-connect-all-points)
