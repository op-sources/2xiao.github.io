...
| 1405 | [最长快乐字符串](https://leetcode.com/problems/longest-happy-string) | [[✓]](/leetcode/problem/1405.md) |  [`贪心`](/leetcode/outline/tag/greedy.md) [`字符串`](/leetcode/outline/tag/string.md) [`堆（优先队列）`](/leetcode/outline/tag/heap-priority-queue.md) | <font color=#ffb800>Medium</font> |
