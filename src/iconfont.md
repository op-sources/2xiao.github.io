<html>
  ...
  <div>
    ...
    ><br />folder:<span class="icon iconfont icon-folder"> </span
    ...
    ><br />storage:<span class="icon iconfont icon-storage"> </span
    ...
    ><br />extend:<span class="icon iconfont icon-extend"> </span
