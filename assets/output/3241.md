...
| 3313 | [查找树中最后标记的节点](https://leetcode.com/problems/find-the-last-marked-nodes-in-tree) |  |  [`树`](/leetcode/outline/tag/tree.md) [`深度优先搜索`](/leetcode/outline/tag/depth-first-search.md) | <font color=#ff334b>Hard</font> |
