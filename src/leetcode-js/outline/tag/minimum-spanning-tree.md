...
| 题号 | 标题 | 题解 | 标签 | 难度 |
| :------: | :------ | :------: | :------ | :------ |
| 1135 | [最低成本连通所有城市](https://leetcode.com/problems/connecting-cities-with-minimum-cost) |  |  [`并查集`](/leetcode-js/outline/tag/union-find.md) [`图`](/leetcode-js/outline/tag/graph.md) [`最小生成树`](/leetcode-js/outline/tag/minimum-spanning-tree.md) `1+` | <font color=#ffb800>Medium</font> |
| 1168 | [水资源分配优化](https://leetcode.com/problems/optimize-water-distribution-in-a-village) |  |  [`并查集`](/leetcode-js/outline/tag/union-find.md) [`图`](/leetcode-js/outline/tag/graph.md) [`最小生成树`](/leetcode-js/outline/tag/minimum-spanning-tree.md) `1+` | <font color=#ff334b>Hard</font> |
...
| 1724 | [检查边长度限制的路径是否存在 II](https://leetcode.com/problems/checking-existence-of-edge-length-limited-paths-ii) |  |  [`并查集`](/leetcode-js/outline/tag/union-find.md) [`图`](/leetcode-js/outline/tag/graph.md) [`最小生成树`](/leetcode-js/outline/tag/minimum-spanning-tree.md) | <font color=#ff334b>Hard</font> |
