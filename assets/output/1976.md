...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`图`](/leetcode-js/outline/tag/graph.md) [`拓扑排序`](/leetcode-js/outline/tag/topological-sort.md) [`动态规划`](/leetcode-js/outline/tag/dynamic-programming.md) [`最短路`](/leetcode-js/outline/tag/shortest-path.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/number-of-ways-to-arrive-at-destination)
