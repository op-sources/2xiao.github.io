...
🟢 <font color=#15bd66>Easy</font>&emsp; 🔖&ensp; [`队列`](/leetcode-js/outline/tag/queue.md) [`哈希表`](/leetcode-js/outline/tag/hash-table.md) [`字符串`](/leetcode-js/outline/tag/string.md) [`计数`](/leetcode-js/outline/tag/counting.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/first-unique-character-in-a-string)
