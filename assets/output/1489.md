...
🔴 <font color=#ff334b>Hard</font>&emsp; 🔖&ensp; [`并查集`](/leetcode-js/outline/tag/union-find.md) [`图`](/leetcode-js/outline/tag/graph.md) [`最小生成树`](/leetcode-js/outline/tag/minimum-spanning-tree.md) [`排序`](/leetcode-js/outline/tag/sorting.md) [`强连通分量`](/leetcode-js/outline/tag/strongly-connected-component.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/find-critical-and-pseudo-critical-edges-in-minimum-spanning-tree)
