...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`动态规划`](/leetcode-js/outline/tag/dynamic-programming.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/ways-to-express-an-integer-as-sum-of-powers)
