...
🟠 <font color=#ffb800>Medium</font>&emsp; 🔖&ensp; [`脑筋急转弯`](/leetcode-js/outline/tag/brainteaser.md) [`数学`](/leetcode-js/outline/tag/math.md)&emsp; 🔗&ensp;[`LeetCode`](https://leetcode.com/problems/bulb-switcher)
...
| 1375 | [二进制字符串前缀一致的次数](https://leetcode.com/problems/number-of-times-binary-string-is-prefix-aligned) |  |  [`数组`](/leetcode-js/outline/tag/array.md) | <font color=#ffb800>Medium</font> |
| 2485 | [找出中枢整数](https://leetcode.com/problems/find-the-pivot-integer) |  |  [`数学`](/leetcode-js/outline/tag/math.md) [`前缀和`](/leetcode-js/outline/tag/prefix-sum.md) | <font color=#15bd66>Easy</font> |
